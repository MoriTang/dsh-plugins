/**
 * Build the cost-balance plugin artifacts:
 *
...
await build({
  ...
  format: 'esm',
  target: 'node20',
  // Host-side @deepseek-ai/* and node builtins resolve from the profile's
  // node_modules; only in-repo workspace deps are external (they link there).
