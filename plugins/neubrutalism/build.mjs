/**
 * Build the neubrutalism plugin artifacts:
 * - lib/index.js  — host half (Node), esbuild ESM bundle (no-op loader entry).
 * - lib/client.js — browser half, emitted as the loader's lazy-CJS factory
 *   artifact (window.__ModuleLoader__.load({ id, factory })).
 *
 * esbuild resolves from the sibling ../deepseek-harness pnpm store; override
 * with DSH_HARNESS.
 */
